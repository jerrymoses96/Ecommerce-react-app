...
const Features = () => {
  return (
    <div className=" pl-0 lg:pl-16 flex flex-col  gap-4 pt-10">
      <div className="flex items-center gap-5">
        <img
          className="w-[50px]"
          src="/src\assets\images\Frame 65.png"
          alt="logo"
        />
        <div>
      ...
      <div className="flex items-center gap-5">
        <img
          className="w-[50px]"
          src="/src\assets\images\Frame 65 (1).png"
          alt="image"
        />
        <div>
      ...
      <div className="flex items-center gap-5">
        <img
          className="w-[50px]"
          src="/src\assets\images\Frame 65 (2).png"
          alt="img"
        />
        <div>
